...
public class FragmentLeft extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.health_second_fragment_left, container, false);
    }
    @Override
    public void onActivityCreated(Bundle savedInstanceState) {
        super.onActivityCreated(savedInstanceState);
        swipeLayout = (SwipeRefreshLayout) getView().findViewById(R.id.swipe_left);
        swipeLayout.setRefreshing(true);
        runInBg();
        recyclerView = (RecyclerView) getView().findViewById(R.id.recycler_view_left);
    ...
    public void runInBg() {
        String url = "";
        if(HealthSecondActivity.leftTitle.equals("食品安全")){
            url = "http://m.ttys5.com/list.php?page="+page+"&style=0&classid=8&bclassid=0&totalnum=12984";
        }
        else if(HealthSecondActivity.leftTitle.equals("营养科普")){
            url = "http://m.ttys5.com/list.php?page="+page+"&style=0&classid=21&bclassid=0&totalnum=22375";
        }
        else if(HealthSecondActivity.leftTitle.equals("男性")){
            url = "http://m.ttys5.com/list.php?page="+page+"&style=0&classid=28&bclassid=0&totalnum=532";
        }
        else if(HealthSecondActivity.leftTitle.equals("运动常识")){
            url = "http://m.ttys5.com/list.php?page="+page+"&style=0&classid=23&bclassid=0&totalnum=6027";
        }
        else if(HealthSecondActivity.leftTitle.equals("心理百科")){
            url = "http://m.ttys5.com/list.php?page="+page+"&style=0&classid=27&bclassid=0&totalnum=6568";
        }
        else if(HealthSecondActivity.leftTitle.equals("体质养生")){
            url = "http://m.ttys5.com/list.php?page="+page+"&style=0&classid=33&bclassid=0&totalnum=767";
        }
